...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_login = findViewById(R.id.tv_masuk2);
        bt_signup = findViewById(R.id.bt_masuk1);
        ...
        bt_signup.setOnClickListener((new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(getNama.isEmpty()){
                            ...
                            Toast.makeText(SignUpActivity.this, "Password Harus Sama",Toast.LENGTH_SHORT).show();
                        }
                        else if (getNama.isEmpty() && getEmail.isEmpty() && getPassword.isEmpty()&& getPassword2.isEmpty()){
                            Toast.makeText(SignUpActivity.this, "Tidak Boleh Ada Yang Kosong",Toast.LENGTH_SHORT).show();
                        }
                            ...
                            auth.createUserWithEmailAndPassword(getEmail,getPassword).addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if(!task.isSuccessful()){
                                        Toast.makeText(SignUpActivity.this, "Daftar Tidak Berhasil,Silahkan Ulangi Lagi", Toast.LENGTH_SHORT).show();
                                        progressBar.setVisibility(View.GONE);
                                    }
                                    else{
                                        ...
                                        dbAkun.setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                if (user.isEmailVerified()){
                                                    ...
                                                    progressBar.setVisibility(View.GONE);
                                                    tools.setSharedPreference(SignUpActivity.this,"namauser",getNama);
                                                    Toast.makeText(SignUpActivity.this,"Tolong Cek Email Untuk Verifikasi Akun",Toast.LENGTH_LONG).show();
