...
public class tools {
    ...
    public static String getSharedPreferenceString1(Activity activity, String preference, String defaultValue) {
        try {
            if (activity != null){
    ...
    public static void setSharedPreference1(Activity activity, String preference, String prefValue) {
        SharedPreferences settings = activity.getSharedPreferences(PREFS_NAME, 0);
